...
ActiveRecord::Schema.define(version: 20170511175223) do
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.integer  "user_id"
    t.integer  "reality_id"
    t.integer  "category_id"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["category_id"], name: "index_favorites_on_category_id", using: :btree
    t.index ["reality_id"], name: "index_favorites_on_reality_id", using: :btree
  ...
  create_table "timers", force: :cascade do |t|
    ...
    t.datetime "created_at",              null: false
    t.datetime "updated_at",              null: false
    t.index ["category_id"], name: "index_timers_on_category_id", using: :btree
    t.index ["user_id"], name: "index_timers_on_user_id", using: :btree
  end
